...
export const es: Translations = {
  ...
  about: {
    title: 'Sobre Mí',
    description: 'Conoceme — quién soy, qué construyo y qué me mueve.',
    subtitle: 'Un poco más',
    text1:
      'Soy un desarrollador de software que siempre intenta mejorar cada día. Me encanta explorar nuevas tecnologías y encontrar cómo pueden resolver problemas reales.',
    text2:
      'Disfruto compartir lo que aprendo con la comunidad dev. No dudes en conectar conmigo en LinkedIn — siempre estoy abierto a conversaciones interesantes.',
    text3:
      'Estoy abierto a oportunidades laborales donde pueda contribuir, crecer y seguir aprendiendo. Si tenés algo que encaje con mi perfil, no dudes en contactarme.',
    skillsTitle: 'Mis Habilidades',
    contactBtn: 'Hablemos',
    highlightsTitle: 'Lo que aporto',
    highlights: [
      'Frontend— React, Next.js y Astro',
      'Integración de IA con AWS Bedrock y LangChain',
      'Full Stack — Node.js, PostgreSQL e infra cloud',
  ...
  chat: {
    ...
    thinking: 'Pensando...',
    noInfo:
      'No tengo información específica sobre eso, ¡pero podés contactarme directamente!',
    error: 'Algo salió mal. Por favor intentá de nuevo.',
    confidence: 'Confianza',
    welcome:
      '¡Hola! Soy el asistente de IA de Guido. Preguntame sobre su experiencia, proyectos o habilidades.',
  },
};
